...
day d = putStrLn "" >> putStrLn "" >> (print =<< getCurrentTime) >> (putStrLn $ "Day " ++ show d ++ " ")
...
main = do
    ...
    day "5 (this takes a couple of seconds)"
    ...
    day "11 (half 2 takes about two hours...)"
    ...
    day "17 (half 2 takes a couple of minutes)"
